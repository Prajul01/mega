                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3 col-md-4">
                        <ul class="faq-menu nav nav-fill nav-pills new-nav-tab" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link @if($key==0)active @endif" id="general-tab" data-bs-toggle="pill"
                                    data-bs-target="#generalTab{{$key}}" type="button" role="tab"
                    ...
                    <div class="col-lg-9 col-md-8">
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            @endphp
                            @if(count($datas)>0)
                            <div class="tab-pane fade show @if($key==0)active @endif" id="generalTab{{$key}}" role="tabpanel"
                                        ...
                                        <div class="accordion-item border-0">
                                            <h2 class="accordion-header" id="generalOne">
                                                <button class="accordion-button @if($k>0) collapsed @endif" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#general-{{$k}}"
                                                    aria-expanded="true" aria-controls="general-one">
                                                    {{$data}}
                                                </button>
                                            </h2>
                                            <div id="general-{{$k}}" class="accordion-collapse collapse @if($k==0) show @endif"
