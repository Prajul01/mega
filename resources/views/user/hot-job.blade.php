...
@section('title'){{ 'Hot Job'}} @endsection
@section('seo_section')
    ...
    <div class="page-content">
        ...
        <div class="main">
            <section class="advertise">
                <div>
                    <img class="w-100" src="{{ asset('frontend/assets/images/premium-advertisement.jpg') }}" alt="">
                </div>
            </section>
                            ...
                            <div class="row steps-wrapper">
                                <div class="col-lg-4 jQueryEqualHeight">
                                    <div class="steps service-card">
                                        ...
                                        <div class="service-body">
                                            <h6 class="new-title">Registration and Job Posting </h6>
                                            <p>Begin by registering and posting your job details. Create a corporate
                                                account to submit the following for your job posting:</p>
                                            <ul>
                                                <li>Job Description and Job Specifications</li>
                                                <li>Your organization's logo and promotional images</li>
                                                <li>A brief organization description</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 jQueryEqualHeight">
                                    <div class="steps service-card">
                                        ...
                                        <div class="service-body">
                                            <h6 class="new-title">Receive Your Customized Page</h6>
                                            <p>
                                                Once registered, you'll receive a customized page tailored to your
                                                organization's nature, featuring your logo and brand colors.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 jQueryEqualHeight">
                                    <div class="steps service-card">
                                        ...
                                        <div class="service-body">
                                            <h6 class="new-title">Payment and Application Reception </h6>
                                            <p>Please note that our service is prepaid. Make your payment to list your
                                                job vacancy in the Top on Premium Job section. Afterward, you can start
                                                receiving applications. Simply log in to your megajob.com employer
                                                account to access applicant profiles and other essential details.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="table-primary" scope="row"> <span class="mobile-only">No. of
                                                        Job Position 2.</span> NRS 22,200</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="table-primary" scope="row"> <span class="mobile-only">No. of
                                                        Job Position 4.</span> NRS 38,600</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="col-lg-3 col-md-3 p-0">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="table-primary" scope="row"> <span class="mobile-only">No. of
                                                        Job Position 2.</span> NRS 9,500</td>
                                            </tr>
                                            <tr>
                                                <td scope="row"> <span class="mobile-only">No. of Job Position 3.</span>
                                                    NRS 11,000</td>
                                            ...
                                            <tr>
                                                <td class="table-primary" scope="row"> <span class="mobile-only">No. of
                                                        Job Position 4.</span> NRS 14,200</td>
                                            </tr>
                                        </tbody>
                                    </table>
