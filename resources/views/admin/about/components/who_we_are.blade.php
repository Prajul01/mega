        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="who_we_are_heading" placeholder="heading"
                        value="{{ old('who_we_are_heading',$about->who_we_are_heading) }}" aria-label="heading" aria-describedby="basic-addon1">
                </div>
                @error('who_we_are_heading')
            ...
            <div class="col-md-8 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="who_we_are_title" placeholder="title"
                        value="{{ old('who_we_are_title',$about->who_we_are_title) }}" aria-label="title" aria-describedby="basic-addon1">
                </div>
            ...
            <div class="col-md-12 mb-3">
                <div class="input-group">
                    ...
                    <input type="file" class="dropify" name="who_we_are_image"  data-default-file="{{ asset('storage/about/' . $about->who_we_are_image) }}">
                </div>
                @error('who_we_are_image')
                <span class="error">{{$message}}</span>
                @enderror
            </div>
            <div class="col-md-12 mb-3">
                <div class="input-group">
                    ...
                    <textarea name="who_we_are_description" id="ckeditor" class="form-control">{!! old('who_we_are_description',$about->who_we_are_description) !!}</textarea>
                </div>
