    ...
    <div class="block-header">
        <div class="row clearfix">
            <div class="col-md-12 col-sm-12">
                <h1>Training Enroll Management</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Training Enroll Management</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    <ul class="nav nav-tabs">
                        @if (request()->routeIs('admin.trainingenroll.edit'))
                            <li class="nav-item">
                                <a class="nav-link show active" data-toggle="tab" href="#editad">
                                    <i class="fa fa-plus"></i> Edit training</a>
                            </li>
                            <li class="nav-item ml-auto">
                                <a class="nav-link show active" href="{{route('admin.trainingenroll.index')}}">
                ...
                <div class="tab-content">
                    @if ($status == 'edit')
                        <div class="tab-pane active show" id="editad">
                            @include('admin.training_enroll.components.edit')
                        </div>
                    @else
                        <div class="tab-pane active show" id="training">
                            @include('admin.training_enroll.components.list')
                        </div>
                        <div class="tab-pane" id="addad">
                            @include('admin.training_enroll.components.add')
                        </div>
                    @endif
                </div>
            </div>
