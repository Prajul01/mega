                    ...
                    <div class="custom-handle-flex">
                        <div class="icon-image-name">
                            <div>
                                <h6 class=" mb-0">
                                    {{ $faq->title }} | <small
                                        class="{{ $faq->status == 'active' ? 'badge badge-primary' : 'badge badge-danger' }}">{{ $faq->status == 'active' ? 'Displayed' : 'Not Display' }}
                                    </small> | {{ $faq->faq_type }}
                                </h6>
                            </div>
                        </div>
                        <div style="display: flex">
                            @can('content-edit')
                                <a href="{{ route('admin.faq.edit', base64_encode($faq->id)) }}"
