...
@endpush
<form method="POST" action="{{ route('admin.industry.update', base64_encode($industry->id)) }}"
            ...
            <div class="col-md-9 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="Industry Name"
                        value="{{ old('name', $industry->name) }}" aria-label="Title"
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><input type="checkbox" name="status" value="active"
                                @if ($industry->status == 'active') checked @endif></span>
                    </div>
    ...
    <div class="card-footer">
        <a href="{{ route('admin.industry.index') }}" class="btn btn-danger">Cancel</a>
