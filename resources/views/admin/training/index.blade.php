            ...
            <div class="card">
                <div class="card-header">
                    <ul class="nav nav-tabs">
                        @if (request()->routeIs('admin.training.edit'))
                            <li class="nav-item">
                                <a class="nav-link show active" data-toggle="tab" href="#editad">
                                    <i class="fa fa-plus"></i> Edit training</a>
                            </li>
                            <li class="nav-item ml-auto">
                                <a class="nav-link show active" href="{{route('admin.training.index')}}">
                ...
                <div class="tab-content">
                    @if ($status == 'edit')
                        <div class="tab-pane active show" id="editad">
                            @include('admin.training.components.edit')
                        </div>
                    @else
                        <div class="tab-pane active show" id="training">
                            @include('admin.training.components.list')
                        </div>
                        <div class="tab-pane" id="addad">
                            @include('admin.training.components.add')
                        </div>
                    @endif
                </div>
            </div>
