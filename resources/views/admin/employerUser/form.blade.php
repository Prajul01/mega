                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ $flag == 1 ? 'Create' : 'Update' }}
                                Employer</li>
                        </ol>
                    </nav>
                </div>
                <div class="col">
                    <a href="{{ route('admin.employers.index') }}" class="btn btn-primary" style="float:right;"><i
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name"
                                        placeholder="Enter Name" value="{{ old('name') ? old('name') : @$user->name }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
