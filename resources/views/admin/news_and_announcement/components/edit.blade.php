...
@endpush
<form method="POST" action="{{ route('admin.news.update', base64_encode($blog->id)) }}" enctype="multipart/form-data">
    @csrf
    <div class="body">
        <div class="row">
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="title" placeholder="Title"
                        value="{{ old('title',$blog->title) }}" aria-label="Title" aria-describedby="basic-addon1" required>
                </div>
                @error('title')
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="company_name" placeholder="Company Name" aria-label="Company Name"
                        aria-describedby="basic-addon1" value="{{old('company_name',$blog->company_name)}}">
                </div>
                @error('company_name')
                <span class="error">{{$message}}</span>
                @enderror
            ...
            <div class="col-md-12 mb-3">
                <div class="input-group">
                    ...
                    <input type="file" name="image" data-default-file="{{ asset('storage/news_and_announcement/' . $blog->image) }}"
                        class="dropify">
            ...
            <div class="col-md-12 mb-3">
                <div class="input-group">
                    ...
                    <textarea name="description" id="ckeditor" class="form-control">{!! old('description',$blog->description) !!}</textarea>
                </div>
                @error('description')
                <span class="error">{{$message}}</span>
                @enderror
