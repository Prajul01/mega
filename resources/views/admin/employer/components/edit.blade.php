...
@endpush
<form method="POST" action="{{ route('admin.employer.update', base64_encode($employer->id)) }}"
        ...
        <div class="row">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><input type="checkbox" name="status" value="active"
                                @if ($employer->status == 'active') checked @endif></span>
                    </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="phone_number" placeholder="Phone Number"
                        aria-label="" aria-describedby="basic-addon1"
                        value="{{ old('phone_number', $employer->phone_number) }}">
                </div>
                @error('phone_number')
                    <span class="error">{{ $message }}</span>
                @enderror
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="file" name="company_logo" class="dropify"
                        data-default-file="{{ old('company_logo', asset('storage/employer/logo' . $employer->logo)) }}">
                </div>
                @error('company_logo')
                    <span class="error">{{ $message }}</span>
                @enderror
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="file" name="image" class="dropify"
                        data-default-file="{{ old('image', asset('storage/employer/thumb_' . $employer->image)) }}">
                </div>
                @error('image')
                    <span class="error">{{ $message }}</span>
                @enderror
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="email" placeholder="Email" aria-label=""
                        aria-describedby="basic-addon1" value="{{ old('email', $email) }}">
                </div>
                @error('email')
                    <span class="error">{{ $message }}</span>
                @enderror
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="address" placeholder="Address" aria-label=""
                        aria-describedby="basic-addon1" value="{{ old('address', $employer->address) }}">
                </div>
                @error('address')
                    <span class="error">{{ $message }}</span>
                @enderror
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="date" class="form-control" id="date" name="expiry_date"
                        ...
                        value="{{ old('expiry_date', $employer->expiry_date) }}">
                </div>
                @error('expiry_date')
                    <span class="error">{{ $message }}</span>
                @enderror
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><input type="checkbox" name="is_verify" value="1"
                                @if ($employer->is_varify == '1') checked @endif></span>
                    </div>
                ...
                <div class="input-group">
                    ...
                    <select class="form-select form-control" aria-label="Default select example"
                        ...
                        @foreach ($company_owner_ships as $company_owner_ship)
                            <option value="{{ $company_owner_ship->id }}"
                                {{ $employer->company_owner_ship_id == $company_owner_ship->id ? 'selected' : '' }}>
                                {{ $company_owner_ship->title }}</option>
                        @endforeach
                    </select>
                </div>
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="company_size">
                        ...
                        @foreach ($company_sizes as $company_size)
                            <option value="{{ $company_size->id }}"
                                {{ $employer->company_size_id == $company_size->id ? 'selected' : '' }}>
                                {{ $company_size->title }}</option>
                        @endforeach
                    </select>
                </div>
                @error('company_size')
                    ...
                    <select class="form-select form-control" aria-label="Default select example"
                        ...
                        @foreach ($company_categories as $company_category)
                            <option value="{{ $company_category->id }}"
                                {{ $employer->company_category_id == $company_category->id ? 'selected' : '' }}>
            ...
            <div class="col-md-12 mb-3">
                <div class="input-group">
                    ...
                    <textarea class="form-control" name="company_website" placeholder="Company Website Url" aria-label=""
                        aria-describedby="basic-addon1">{{ old('company_website', $employer->company_website) }}</textarea>
                </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <textarea class="form-control" id="ckeditor" name="company_description" placeholder="Company description"
                        rows="6" aria-label="" aria-describedby="basic-addon1">{{ old('company_description', $employer->company_description) }}</textarea>
                </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <textarea class="form-control" id="ckeditor1" name="services" placeholder="Additional Information" rows="6"
                        aria-label="" aria-describedby="basic-addon1">{{ old('services', $employer->services) }}</textarea>
                </div>
                @error('services')
                    <span class="error">{{ $message }}</span>
                @enderror
                    ...
                    <select class="form-select form-control country" aria-label="Default select example"
                        ...
                        @foreach ($countries as $country)
                            <option value="{{ $country->id }}"
                                {{ $employer->country_id == $country->id ? 'selected' : '' }}>{{ $country->name }}
                            </option>
                        @endforeach
                    </select>
                </div>
                    ...
                    <select class="form-select form-control province-list" id="province"
                        ...
                        @foreach ($provinces as $province)
                            <option value="{{ $province->id }}"
                                {{ $employer->province_id == $province->id ? 'selected' : '' }}>{{ $province->name }}
                            </option>
                        @endforeach
                    </select>
                </div>
                    ...
                    <select class="form-select form-control district-list" aria-label="Default select example"
                        ...
                        @foreach ($districts as $district)
                            <option value="{{ $district->id }}"
                                {{ $employer->district_id == $district->id ? 'selected' : '' }}>{{ $district->name }}
                            </option>
                        @endforeach
                    </select>
                </div>
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="city">
                        ...
                        @foreach ($cities as $city)
                            <option value="{{ $city->id }}"
                                {{ $employer->city_id == $city->id ? 'selected' : '' }}>
                                {{ $city->name }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="col-md-12 mb-2">
                @if (isset($personal_info))
                    @foreach ($personal_info->name as $key => $person)
                        <div class="row mb-2 border p-2 mx-2 personal">
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $person }}"
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ $personal_info->email[$key] }}" name="personal_email[]"
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ $personal_info->designation[$key] }}" name="personal_designation[]"
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ $personal_info->number[$key] }}" name="personal_phone[]"
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="{{ $inputName }}" value="{{ $employer->$inputName }}" placeholder="{{ ucfirst($social) }} URL" required/>
                        </div>
                        @error($inputName)
                        <span class="error">{{$message}}</span>
                        @enderror
