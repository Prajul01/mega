<form method="POST" action="{{ route('admin.concern.update' ,base64_encode($concern->id)) }}" enctype="multipart/form-data">
    @csrf
    <div class="body">
        <div class="row">
            <div class="col-md-9 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="concern" placeholder="Concern" aria-label="concern"
                        aria-describedby="basic-addon1" value="{{old('concern', $concern->concern)}}" required>
                </div>
                @error('concern')
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><input type="checkbox" name="display"
                                {{ old('display', $concern->display)? (old('display', $concern->display)? 'checked': ''): 'checked' }}></span>
                    </div>
