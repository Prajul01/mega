        ...
        <div class="block-header">
            <div class="row clearfix">
                <div class="col-md-12 col-sm-12">
                    <h1>Privacy Policies Management</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Privacy Policies Management</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a class="nav-link show active" data-toggle="tab" href="#projects">
                                        <i class="fa fa-list"></i> Update Privacy Policies
                                    </a>
                                </li>
                        </ul>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="input-group">
                                        ...
                                        <textarea name="description"  class="form-control"  id="ckeditor" rows="5" required>{{ old('description',$privacy->description) }}</textarea>
                                    </div>
                                    @error('description')
