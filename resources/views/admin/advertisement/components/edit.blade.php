<form method="POST" action="{{ route('admin.advertisement.update', base64_encode($ad->id)) }}" enctype="multipart/form-data">
    @csrf
    <div class="card m-1">
        <div class="card-body">
            <div class="row">
                        ...
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <input type="checkbox" name="display" value="1"
                                    @if (old('display') || $ad->display == '1') checked @endif>
                            </div>
                        </div>
                ...
                <div class="col-md-6 mt-2">
                    <div class="input-group">
                        ...
                        <select class="form-select form-control" aria-label="Default select example" name="type" id="type">
                            ...
                            <option value="1" {{old('type')|| $ad->type=='1'?'selected':''}}>Main Banner</option>
                            <option value="2" {{old('type') || $ad->type=='2'?'selected':''}}>Side Bar Video</option>
                            <option value="3" {{old('type') || $ad->type=='3'?'selected':''}}>Side Bar Image</option>
                          </select>  
                    @error('type')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="input-group mb-3">
                        ...
                        <input type="file" name="image" class="bg-primary text-white form-control" value=""  data-default-file="{{ asset('storage/advertisement/' . $ad->image) }}">
                    </div>
                    @error('image')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                   ...
                   <div>
                    <img src="{{ asset('storage/advertisement/' . $ad->image) }}" alt="" style="height:100px;width:auto;">
                   </div>
            ...
            <div class="row">
                <div class="col-md-12 mt-2">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" value="{{old('url',$ad->url)}}" name="url"
