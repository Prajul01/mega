...
@endpush
<form method="POST" action="{{ route('admin.companyFAQ.store') }}" enctype="multipart/form-data">
    @csrf
    <div class="body">
        <div class="row">
            <div class="col-md-9 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="question" placeholder="question"
                        aria-label="question" aria-describedby="basic-addon1" value="{{ old('question') }}" required>
                </div>
                @error('question')
            ...
            <div class="col-md-12">
                ...
                <textarea class="form-control" name="answer" style="height: 250px;"></textarea>
