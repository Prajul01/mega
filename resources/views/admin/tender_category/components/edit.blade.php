...
@endpush
<form method="POST" action="{{ route('admin.tender_category.update', base64_encode($tender_category->id)) }}" enctype="multipart/form-data">
    @csrf
    <div class="body">
        <div class="row">
            <div class="col-md-9 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="title" placeholder="Title"
                        value="{{ old('title',$tender_category->title) }}" aria-label="Title" aria-describedby="basic-addon1" required>
                </div>
                @error('title')
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><input type="checkbox" name="status" value="active"
                                @if ($tender_category->status == 'active') checked @endif></span>
                    </div>
    ...
    <div class="card-footer">
        <a href="{{ route('admin.tender_category.index') }}" class="btn btn-danger">Cancel</a>
