...
@endpush
<form method="POST" action="{{ route('admin.skill.update', base64_encode($skill->id)) }}" enctype="multipart/form-data">
    @csrf
    <div class="body">
        <div class="row">
            <div class="col-md-9 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="title" placeholder="Title"
                        value="{{ old('title',$skill->title) }}" aria-label="Title" aria-describedby="basic-addon1" required>
                </div>
                @error('title')
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><input type="checkbox" name="status" value="active"
                                @if ($skill->status == 'active') checked @endif></span>
                    </div>
            ...
            <div class="col-md-12 mb-3">
                <div class="input-group">
                    ...
                    <textarea name="description" id="ckeditor" class="form-control">{!! old('description',$skill->description) !!}</textarea>
                </div>
                @error('description')
                <span class="error">{{$message}}</span>
                @enderror
    ...
    <div class="card-footer">
        <a href="{{ route('admin.skill.index') }}" class="btn btn-danger">Cancel</a>
