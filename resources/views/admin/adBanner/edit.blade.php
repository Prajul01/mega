                ...
                <div class="card">
                    <form action="{{ route('admin.steps.update', base64_encode($step->id)) }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <label for="" class="form-label">Title</label>
                                <textarea class="form-control" placeholder="Description" rows=15 name="description">{{ old('description', @$description) }}</textarea>
                            </div>
                        </div>
                        <div class="card-footer">
                            <div class="col-md-12">
                                ...
                                <button class="btn btn-success" style="float:right;" name="step" value="{{ $stepNo }}"><i
                                        class="fa fa-arrow-up"></i>&nbsp;Update</button>
                            </div>
                        </div>
                    </form>
