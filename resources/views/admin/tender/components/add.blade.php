        ...
        <div class="row">
            ...
            <div class="col-md-8 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="sub_title" placeholder="Sub Title" aria-label="Title"
                        aria-describedby="basic-addon1" value="{{old('sub_title')}}">
                </div>
                @error('sub_title')
                <span class="error">{{$message}}</span>
                @enderror
            ...
            <div class="col-md-4 mb-3">
                <div class="input-group">
                    ...
                    <input type="date" class="form-control" id="date" name="deadline_date" placeholder="Date" aria-label="Date"
                        aria-describedby="basic-addon1" value="{{old('deadline_date')}}">
                </div>
                @error('deadline_date')
                <span class="error">{{$message}}</span>
                @enderror
            ...
            <div class="col-md-12 mb-3">
                <div class="input-group">
                    ...
                    <select class="multiple-cat form-control" name="tag[]" multiple="multiple">
                        @foreach($tags as $tag)
                           <option value="{{$tag->title}}"  {{ old('tag') == $tag->title ? 'selected' : '' }}>
                           {{$tag->title}}
                           </option>
                           @endforeach
                   </select>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="tender_category">
                        ...
                        <option value="{{$category->id}}" {{old('tender_category')==$category->id?'selected':''}}>{{$category->title}}</option>
                        @endforeach
                      </select>
                </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="tender_type">
                        ...
                        <option value="{{$type->id}}" {{old('tender_type')==$type->id?'selected':''}}>{{$type->title}}</option>
                        @endforeach
                      </select>
                </div>
                @error('tender_type')
            ...
            <div class="col-md-12 mb-3">
                <div class="input-group">
                    ...
                    <textarea name="description"  class="form-control"  id="ckeditor" rows="5">{{ old('description') }}</textarea>
                </div>
                @error('description')
                <span class="error">{{$message}}</span>
                @enderror
            ...
            <div class="col-md-12 mb-3">
                <div class="input-group">
                    ...
                    <input type="file" name="logo" class="dropify" data-default-file="{{ old('logo') }}">
                </div>
                @error('logo')
                <span class="error">{{$message}}</span>
                @enderror
