...
<body>
    <form method="post" action="{{ route('securelogin') }}">
        ...
        <div class="inputGroup inputGroup1">
            ...
            <input type="email" id="loginEmail" maxlength="254" class="@error('email') is-invalid @enderror"
                name="email" value="{{ old('email') }}" required />
            <p class="helper helper1">email@domain.com</p>
        </div>
        <div class="inputGroup inputGroup2">
            <label for="loginPassword" id="loginPasswordLabel">Password</label>
            <input type="password" id="loginPassword" class="@error('password') is-invalid @enderror"
    ...
    <div class="image-container">
        ...
        <div class="img-cty">
            <a href="{{ url('/') }}" target="_blank"><img width="100px"
                    src="{{ isset($setting) ? asset('storage/setting/favicon/' . $setting->favicon) : '' }}"
                    alt="{{ isset($setting) ? $setting->sitetitle : '' }}"></a>
        </div>
        <div class="img-rush">
            <a href="https://www.ktmrush.com/" target="_blank"><img
                    src="{{ asset('backend/login/LOGO-final.png') }}" alt="KTM Rush"></a>
        </div>
    </div>
    ...
    @error('password')
        <div data-notify="container"
            ...
            <span data-notify="message">Sorry!! <br> {{ $message }}</span>
