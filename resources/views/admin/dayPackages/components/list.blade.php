    ...
    <div class="dd" id="nestable">
        <ol class="dd-list has-header">
            @foreach ($packages as $package)
                <li class="dd-item dd3-item list-item" data-id="{{ $package->id }}">
                    ...
                    <div class="custom-handle-flex">
                        ...
                        <div style="display: flex">
                            ...
                            <a href="{{ route('admin.dayPackages.edit', base64_encode($package->id)) }}"
                            ...
                            &nbsp;
                            <button type="button" onclick="COnfirmDelete('{{ base64_encode($package->id) }}')"
                                data-id="{{ $package->id }}" class="btn btn-sm btn-outline-danger"><i
    ...
    <script>
        $(document).ready(function() {
            var updateOutput = function(e) {
                ...
                $.ajax({
                    method: "POST",
                    url: "{{ route('admin.dayPackages.order') }}",
                    data: {
        ...
        function COnfirmDelete(elem) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        method: "POST",
                        url: '{{ route('admin.dayPackages.destroy') }}',
                        data: {
                            '_token': '{{ csrf_token() }}',
                            'id': id
                        },
