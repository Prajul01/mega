        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="job_name" placeholder="Job Name" aria-label=""
                        aria-describedby="basic-addon1" value="{{ old('job_name') }}" required>
                </div>
                @error('job_name')
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="number" class="form-control" name="no_of_opening" placeholder="No Of Opening"
                        aria-label="" aria-describedby="basic-addon1" value="{{ old('no_of_opening') }}">
                </div>
                @error('no_of_opening')
                    <span class="error">{{ $message }}</span>
                @enderror
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="date" class="form-control" name="active_on"
                        value="{{ old('active_on', date('Y-m-d', strtotime(today()))) }}">
                </div>
                @error('active_on')
                    <span class="error">{{ $message }}</span>
                @enderror
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="date" class="form-control" name="expires_on"
                        value="{{ old('expires_on', date('Y-m-d', strtotime(today()->addDays(15)))) }}">
                </div>
                @error('expires_on')
                    <span class="error">{{ $message }}</span>
                @enderror
                ...
                <div class="input-group">
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="employer">
                        ...
                        @foreach ($employers as $employe)
                            <option value="{{ $employe->id }}" {{ old('user') == $employe->id ? 'selected' : '' }}>
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="job_level">
                        ...
                        @foreach ($job_levels as $job_level)
                            <option value="{{ $job_level->id }}"
                                {{ old('job_level') == $job_level->id ? 'selected' : '' }}>{{ $job_level->title }}
                            </option>
                        @endforeach
                    </select>
                </div>
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="education">
                        ...
                        @foreach ($educations as $education)
                            <option value="{{ $education->id }}"
                                {{ old('education') == $education->id ? 'selected' : '' }}>{{ $education->title }}
                            </option>
                        @endforeach
                    </select>
                </div>
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="experience">
                        ...
                        @foreach ($experiences as $experience)
                            <option value="{{ $experience->id }}"
                                {{ old('experience') == $experience->id ? 'selected' : '' }}>{{ $experience->title }}
                            </option>
                        @endforeach
                    </select>
                </div>
                    ...
                    <select class="form-select form-control" aria-label="Default select example"
                        ...
                        @foreach ($company_categories as $company_category)
                            <option value="{{ $company_category->id }}"
                                {{ old('company_category') == $company_category->id ? 'selected' : '' }}>
                    ...
                    <select class="form-select form-control" aria-label="Default select example"
                        ...
                        @foreach ($employee_types as $employee_type)
                            <option value="{{ $employee_type->id }}"
                                {{ old('employee_type') == $employee_type->id ? 'selected' : '' }}>
                    ...
                    <select class="multiple-cat form-control" name="license_id[]" multiple="multiple">
                        @foreach ($vehicles as $vehicle)
                            <option value="{{ $vehicle->id }}"
                                {{ old('license_id') == $vehicle->id ? 'selected' : '' }}>
                                {{ $vehicle->title }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-12 mb-3 jobDesc-info">
                <div class="input-group">
                    ...
                    <textarea class="form-control" id="ckeditor" name="job_description" placeholder="Job description" rows="6"
                        aria-label="" aria-describedby="basic-addon1">{{ old('job_description') }}</textarea>
                </div>
            ...
            <div class="col-md-12 mb-3 jobDesc-info">
                <div class="input-group">
                    ...
                    <textarea class="form-control" id="ckeditor1" name="job_specification" placeholder="Job Specification"
                        rows="6" aria-label="" aria-describedby="basic-addon1">{{ old('job_specification') }}</textarea>
                </div>
            ...
            <div class="col-md-12 mb-3 newspaper-image display-no">
                <div class="input-group">
                    ...
                    <input type="file" name="newspaper_image" class="dropify"
                        data-default-file="{{ old('newspaper_image') }}">
                </div>
            ...
            <div class="col-md-12 mb-3">
                <div class="input-group">
                    ...
                    <input type="file" name="banner" class="dropify" data-default-file="{{ old('banner') }}">
                </div>
                @error('banner')
                    <span class="error">{{ $message }}</span>
                @enderror
                ...
                <div class="input-group">
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="salary_range">
                        ...
                        @foreach ($salary_array as $data)
                            <option value="{{ $data }}"
                                {{ old('salary_range') ? (old('salary_range') == $data ? 'selected' : '') : '' }}>
                                {{ $data }}</option>
                        @endforeach
                    </select>
                </div>
