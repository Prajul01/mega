                                ...
                                <tbody>
                                    <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <th>
                                                <a href="<?php echo e(route('admin.pricing.index', base64_encode($step->id))); ?>" class="btn btn-success">
                                                    <i class="fa fa-usd"></i>
                                                </a>
                                            </th>
                                        </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/megajobn/public_html/resources/views/admin/pricing/mainIndex.blade.php ENDPATH**/ ?>