            ...
            <tbody>
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><span class="badge badge-success"><?php echo e($user->getRoleNames()[0]); ?></span></td>
                        ...
                        <td style="display:flex;">
                            <a href="<?php echo e(route('admin.adminUsers.edit', base64_encode($user->id))); ?>"
                                class="btn btn-outline-warning mr-1">
                                <i class="fa fa-edit"></i>
                            </a>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-edit')): ?>
                                <?php if(auth()->user()->id != $user->id): ?>
                                    <form action="<?php echo e(route('admin.adminUsers.suspend', base64_encode($user->id))); ?>"
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-delete')): ?>
                                <form action="<?php echo e(route('admin.adminUsers.destroy', base64_encode($user->id))); ?>"
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/megajobn/public_html/resources/views/admin/users/components/userList.blade.php ENDPATH**/ ?>