...
<head>
    ...
    <link href="<?php echo e(asset('backend/login/style.css')); ?>" rel="stylesheet" type="text/css" media="all" />
...
<body>
    <form method="post" action="<?php echo e(route('securelogin')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="inputGroup inputGroup1">
            ...
            <input type="email" id="loginEmail" maxlength="254" class="<?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>"
        ...
        <div class="inputGroup inputGroup2">
            ...
            <input type="password" id="loginPassword" class="<?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="image-container">
        ...
        <div class="img-cty">
            <a href="<?php echo e(url('/')); ?>" target="_blank"><img width="100px"
                    src="<?php echo e(isset($setting) ? asset('storage/setting/favicon/' . $setting->favicon) : ''); ?>"
                    alt="<?php echo e(isset($setting) ? $setting->sitetitle : ''); ?>"></a>
        </div>
        <div class="img-rush">
            <a href="https://www.ktmrush.com/" target="_blank"><img
                    src="<?php echo e(asset('backend/login/LOGO-final.png')); ?>" alt="KTM Rush"></a>
        </div>
    </div>
    <p class="foot-note"><code>Rush Admin 4.0</code></p>
...
$message = $__bag->first($__errorArgs[0]); ?>
        <div data-notify="container"
            class="col-11 col-md-4 alert alert-danger alert-with-icon animated fadeInDown alert-message" role="alert"
            data-notify-position="bottom-right"
            style="display: inline-block; margin: 15px auto; position: fixed; transition: all 0.5s ease-in-out 0s; z-index: 1031; bottom: 50px; left: 450px;">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <i class="fa fa-times"></i>
            </button>
            <i data-notify="icon" class="fa fa-bell"></i>
            <span data-notify="title"></span>
            <span data-notify="message">Sorry!! <br> <?php echo e($message); ?></span>
...
unset($__errorArgs, $__bag); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('backend/login/morphsvg.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('backend/login/tweenMax.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('backend/login/script.js')); ?>"></script>
...
<?php /**PATH /home/megajobn/public_html/resources/views/admin/login.blade.php ENDPATH**/ ?>