...
<?php $__env->stopPush(); ?>
<form method="POST" action="<?php echo e(route('admin.skill.update', base64_encode($skill->id))); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="body">
        <div class="row">
            <div class="col-md-9 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="title" placeholder="Title"
                        value="<?php echo e(old('title',$skill->title)); ?>" aria-label="Title" aria-describedby="basic-addon1" required>
                </div>
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><input type="checkbox" name="status" value="active"
                                <?php if($skill->status == 'active'): ?> checked <?php endif; ?>></span>
                    </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-12 mb-3">
                <div class="input-group">
                    ...
                    <textarea name="description" id="ckeditor" class="form-control"><?php echo old('description',$skill->description); ?></textarea>
                </div>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="card-footer">
        <a href="<?php echo e(route('admin.skill.index')); ?>" class="btn btn-danger">Cancel</a>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/megajobn/public_html/resources/views/admin/skill/components/edit.blade.php ENDPATH**/ ?>