<form method="POST" action="<?php echo e(route('admin.advertisement.update', base64_encode($ad->id))); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="card m-1">
        <div class="card-body">
            <div class="row">
                <div class="col-md-9">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo e(old('title', $ad->title)); ?>"
                        ...
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <input type="checkbox" name="display" value="1"
                                    <?php if(old('display') || $ad->display == '1'): ?> checked <?php endif; ?>>
                            </div>
                        </div>
                ...
                <div class="col-md-6 mt-2">
                    <div class="input-group">
                        ...
                        <select class="form-select form-control" aria-label="Default select example" name="type" id="type">
                            ...
                            <option value="1" <?php echo e(old('type')|| $ad->type=='1'?'selected':''); ?>>Main Banner</option>
                            <option value="2" <?php echo e(old('type') || $ad->type=='2'?'selected':''); ?>>Side Bar Video</option>
                            <option value="3" <?php echo e(old('type') || $ad->type=='3'?'selected':''); ?>>Side Bar Image</option>
                          </select>  
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="input-group mb-3">
                        ...
                        <input type="file" name="image" class="bg-primary text-white form-control" value=""  data-default-file="<?php echo e(asset('storage/advertisement/' . $ad->image)); ?>">
                    </div>
...
unset($__errorArgs, $__bag); ?>
                   ...
                   <div>
                    <img src="<?php echo e(asset('storage/advertisement/' . $ad->image)); ?>" alt="" style="height:100px;width:auto;">
                   </div>
            ...
            <div class="row">
                <div class="col-md-12 mt-2">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo e(old('url',$ad->url)); ?>" name="url"
...
<?php /**PATH /home/megajobn/public_html/resources/views/admin/advertisement/components/edit.blade.php ENDPATH**/ ?>