                                ...
                                <tbody data-test="table-body">
                                    <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($report->phone_no); ?></td>
                                            <td><span class="badge badge-<?php echo e($report->read? 'success': 'danger'); ?>"><?php echo e($report->read? 'Read': 'Not Read'); ?></span></td>
                                            <td><?php echo e(date('d M, Y', strtotime($report->created_at))); ?></td>
                                            <td>
                                                <a href="<?php echo e(route('admin.reports.show', base64_encode($report->id))); ?>" class="btn btn-success"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/megajobn/public_html/resources/views/admin/reports/index.blade.php ENDPATH**/ ?>