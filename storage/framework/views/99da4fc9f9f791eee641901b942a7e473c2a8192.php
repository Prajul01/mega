<form method="POST" action="<?php echo e(route('admin.company_category.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="body">
        <div class="row">
                ...
                <div class="input-group">
                    ...
                    <select name="industry_id" class="form-control" id="">
                        ...
                        <?php $__currentLoopData = App\Models\Industry::where('status', 'active')->select('id', 'name')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $industry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($industry->id); ?>" <?php echo e(old('industry_id') == $industry->id ? 'selected' : ''); ?>>
...
<?php /**PATH /home/megajobn/public_html/resources/views/admin/company_category/components/add.blade.php ENDPATH**/ ?>