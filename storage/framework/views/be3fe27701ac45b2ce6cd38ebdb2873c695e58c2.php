...
<?php $__env->startSection('title', 'Site Info Management'); ?>
                ...
                <div class="card custom-card">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('site-edit')): ?>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="text" name="mobile" class="form-control" aria-label="Small"
                                                ...
                                                value="<?php echo e($setting->mobile); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="text" name="facebook_url" class="form-control"
                                                ...
                                                placeholder="Enter Facebook Url" value="<?php echo e($setting->facebook_url); ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="text" name="instagram_url" class="form-control"
                                                aria-label="Small" aria-describedby="inputGroup-sizing-sm"
                                                placeholder="Enter Instagram Url" value="<?php echo e($setting->instagram_url); ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="text" name="twitter_url" class="form-control"
                                                aria-label="Small" aria-describedby="inputGroup-sizing-sm"
                                                placeholder="Enter Twitter Url" value="<?php echo e($setting->twitter_url); ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="text" name="youtube_url" class="form-control"
                                                aria-label="Small" aria-describedby="inputGroup-sizing-sm"
                                                placeholder="Enter Youtube Url" value="<?php echo e($setting->youtube_url); ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="text" name="linkedin_url" class="form-control"
                                                aria-label="Small" aria-describedby="inputGroup-sizing-sm"
                                                placeholder="Enter LinkedIn Url" value="<?php echo e($setting->linkedin_url); ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <textarea name="address" id="" cols="30" rows="3" class="form-control"><?php echo e(old('address', @$setting->address)); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="input-group mb-3">
                                            ...
                                            <textarea class="form-control" rows=3 name="google_map_url" aria-label="With textarea"><?php echo $setting->googlemap_url; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="file" name="logo"
                                            data-default-file="<?php echo e(asset('storage/setting/logo/' . $setting->logo)); ?>"
                                            class="dropify">
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="file" name="favicon"
                                            data-default-file="<?php echo e(asset('storage/setting/favicon/' . $setting->favicon)); ?>"
                                            class="dropify">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="text" name="meta_title" class="form-control" aria-label="Small"
                                            ...
                                            value="<?php echo e(old('meta_title', @$setting->meta_title)); ?>">
                                    </div>
                                </div>
                                <div class="col-sm-12 mb-3">
                                    <div class="input-group mb-3">
                                        ...
                                        <textarea class="form-control" rows=4 name="meta_content" aria-label="With textarea"><?php echo e(old('meta_content', @$setting->meta_description)); ?></textarea>
                                    </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <input type="text" name="og_title" class="form-control"
                                                ...
                                                value="<?php echo e(old('og_title', @$setting->og_title)); ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="input-group mb-3">
                                            ...
                                            <textarea class="form-control" rows=4 name="og_content" aria-label="With textarea"><?php echo e(old('og_content', @$setting->og_description)); ?></textarea>
                                        </div>
                                        <span class="alert alert-warning">Please enter 155 - 160 words for better
                                            results</span>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="file"
                                            data-default-file="<?php echo e(asset('storage/setting/og-image/' . $setting->og_image)); ?>"
                        ...
                        <div class="card-footer">
                            <div class="col-md-12">
                                <a href="<?php echo e(route('admin.setting.index')); ?>" class="btn btn-outline-danger">Cancel</a>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('site-edit')): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/megajobn/public_html/resources/views/admin/setting/form.blade.php ENDPATH**/ ?>