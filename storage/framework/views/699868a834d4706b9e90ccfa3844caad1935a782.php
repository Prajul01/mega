    ...
    <div class="dd" id="nestable">
        <ol class="dd-list has-header">
            <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="dd-item dd3-item list-item" data-id="<?php echo e($package->id); ?>">
                    <div class="dd-handle dd3-handle"></div>
                    <div class="custom-handle-flex">
                        <div class="icon-image-name">
                            <div>
                                <h6 class=" mb-0">
                                    <?php echo e($package->days); ?>
                        ...
                        <div style="display: flex">
                            ...
                            <a href="<?php echo e(route('admin.dayPackages.edit', base64_encode($package->id))); ?>"
                            ...
                            &nbsp;
                            <button type="button" onclick="COnfirmDelete('<?php echo e(base64_encode($package->id)); ?>')"
                                data-id="<?php echo e($package->id); ?>" class="btn btn-sm btn-outline-danger"><i
    ...
    <script>
        $(document).ready(function() {
            var updateOutput = function(e) {
                ...
                $.ajax({
                    method: "POST",
                    url: "<?php echo e(route('admin.dayPackages.order')); ?>",
                    data: {
        ...
        function COnfirmDelete(elem) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        method: "POST",
                        url: '<?php echo e(route('admin.dayPackages.destroy')); ?>',
                        data: {
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/megajobn/public_html/resources/views/admin/dayPackages/components/list.blade.php ENDPATH**/ ?>