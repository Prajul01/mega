...
<?php $__env->stopPush(); ?>
<form method="POST" action="<?php echo e(route('admin.district.update', base64_encode($district->id))); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="body">
        <div class="row">
            <div class="col-md-9 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="district_name" placeholder="Title"
                        value="<?php echo e(old('district_name',$district->name)); ?>" aria-label="Title" aria-describedby="basic-addon1" required>
                </div>
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><input type="checkbox" name="status" value="active"
                                <?php if($district->status == 'active'): ?> checked <?php endif; ?>></span>
                    </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="province_name">
                        ...
                        <option value="<?php echo e($province->id); ?>" <?php echo e($province->id==$district->id?"selected":''); ?>><?php echo e($province->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="card-footer">
        <a href="<?php echo e(route('admin.district.index')); ?>" class="btn btn-danger">Cancel</a>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/megajobn/public_html/resources/views/admin/district/components/edit.blade.php ENDPATH**/ ?>