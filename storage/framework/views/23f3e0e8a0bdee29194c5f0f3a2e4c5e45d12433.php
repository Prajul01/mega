<form method="POST" action="<?php echo e(route('admin.JobLevel.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="body">
        <div class="row">
...
<?php /**PATH /home/megajobn/public_html/resources/views/admin/jobLevel/components/add.blade.php ENDPATH**/ ?>