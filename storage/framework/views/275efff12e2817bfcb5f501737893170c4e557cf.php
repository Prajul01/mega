    ...
    <div class="dd" id="nestable">
        <ol class="dd-list has-header">
            <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="dd-item dd3-item list-item" data-id="<?php echo e($faq->id); ?>">
                    <div class="dd-handle dd3-handle"></div>
                    <div class="custom-handle-flex">
                        <div class="icon-image-name">
                            <div>
                                <h6 class=" mb-0">
                                    <?php echo e($faq->title); ?> | <small
                                        class="<?php echo e($faq->status == 'active' ? 'badge badge-primary' : 'badge badge-danger'); ?>"><?php echo e($faq->status == 'active' ? 'Displayed' : 'Not Display'); ?>

                                    </small> | <?php echo e($faq->faq_type); ?>
                        ...
                        <div style="display: flex">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('content-edit')): ?>
                                <a href="<?php echo e(route('admin.faq.edit', base64_encode($faq->id))); ?>"
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('content-delete')): ?>
                                &nbsp;
                                <button type="button" onclick="COnfirmDelete('<?php echo e($faq->id); ?>')"
                                    data-id="<?php echo e($faq->id); ?>" class="btn btn-sm btn-outline-danger">
    ...
    <script>
        $(document).ready(function() {
            var updateOutput = function(e) {
                ...
                $.ajax({
                    method: "POST",
                    url: "<?php echo e(route('admin.faq.order')); ?>",
                    data: {
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/megajobn/public_html/resources/views/admin/faq/components/list.blade.php ENDPATH**/ ?>