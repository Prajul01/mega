...
<?php $__env->stopPush(); ?>
<form method="POST" action="<?php echo e(route('admin.job.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="body">
        <div class="row">
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="job_name" placeholder="Job Name" aria-label=""
                        aria-describedby="basic-addon1" value="<?php echo e(old('job_name')); ?>" required>
                </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-3 mb-3">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><input type="checkbox" name="featured" value="1"></span>
                    </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="number" class="form-control" name="no_of_opening" placeholder="No Of Opening"
                        aria-label="" aria-describedby="basic-addon1" value="<?php echo e(old('no_of_opening')); ?>">
                </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <select class="form-control" name="desired_candidate">
                        <option disabled>--Select Desired--</option>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="date" class="form-control" name="active_on"
                        value="<?php echo e(old('active_on', date('Y-m-d', strtotime(today())))); ?>">
                </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="date" class="form-control" name="expires_on"
                        value="<?php echo e(old('expires_on', date('Y-m-d', strtotime(today()->addDays(15))))); ?>">
                </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="employer">
                        <option selected disabled value="">Select Employer</option>
                        <?php $__currentLoopData = $employers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($employe->id); ?>" <?php echo e(old('user') == $employe->id ? 'selected' : ''); ?>>
                ...
                <div class="input-group">
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="user">
                        ...
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($user->id); ?>" <?php echo e(old('user') == $user->id ? 'selected' : ''); ?>>
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="job_level">
                        ...
                        <?php $__currentLoopData = $job_levels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job_level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($job_level->id); ?>"
                                <?php echo e(old('job_level') == $job_level->id ? 'selected' : ''); ?>><?php echo e($job_level->title); ?>
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="education">
                        ...
                        <?php $__currentLoopData = $educations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $education): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($education->id); ?>"
                                <?php echo e(old('education') == $education->id ? 'selected' : ''); ?>><?php echo e($education->title); ?>
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="experience">
                        ...
                        <?php $__currentLoopData = $experiences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $experience): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($experience->id); ?>"
                                <?php echo e(old('experience') == $experience->id ? 'selected' : ''); ?>><?php echo e($experience->title); ?>
                    ...
                    <select class="form-select form-control" aria-label="Default select example"
                        ...
                        <?php $__currentLoopData = $company_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($company_category->id); ?>"
                                <?php echo e(old('company_category') == $company_category->id ? 'selected' : ''); ?>>
                    ...
                    <select class="form-select form-control" aria-label="Default select example"
                        ...
                        <?php $__currentLoopData = $employee_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($employee_type->id); ?>"
                                <?php echo e(old('employee_type') == $employee_type->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-3 mb-3">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><input type="checkbox" name="job_type" value="0"
                                id="generalJob" checked></span>
                    </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-3 mb-3">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><input type="checkbox" name="job_type_1" value="1"
                                id="newspaperJob"></span>
                    </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-12 mb-3">
                <div class="input-group new-flex">
                    <div class="input-group-prepend">
                    ...
                    <select class="multiple-cat form-control" name="license_id[]" multiple="multiple">
                        <?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($vehicle->id); ?>"
                                <?php echo e(old('license_id') == $vehicle->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-12 mb-3 jobDesc-info">
                <div class="input-group">
                    <div class="input-group-prepend">
                    ...
                    <textarea class="form-control" id="ckeditor" name="job_description" placeholder="Job description" rows="6"
                        aria-label="" aria-describedby="basic-addon1"><?php echo e(old('job_description')); ?></textarea>
                </div>
            ...
            <div class="col-md-12 mb-3 jobDesc-info">
                <div class="input-group">
                    ...
                    <textarea class="form-control" id="ckeditor1" name="job_specification" placeholder="Job Specification"
                        rows="6" aria-label="" aria-describedby="basic-addon1"><?php echo e(old('job_specification')); ?></textarea>
                </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-12 mb-3 newspaper-image display-no">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">Newspaper Image</span>
                    </div>
                    <input type="file" name="newspaper_image" class="dropify"
                        data-default-file="<?php echo e(old('newspaper_image')); ?>">
                </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-12 mb-3">
                <div class="input-group">
                    ...
                    <input type="file" name="banner" class="dropify" data-default-file="<?php echo e(old('banner')); ?>">
                </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="pay_type">
                        ...
                        <option value="monthly"<?php echo e(old('pay_type') == 'monthly' ? 'selected' : ''); ?>>Monthly</option>
                        <option value="weekly" <?php echo e(old('pay_type') == 'weekly' ? 'selected' : ''); ?>>Weekly</option>
                    </select>
                </div>
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="salary_range">
                        ...
                        <?php $__currentLoopData = $salary_array; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($data); ?>"
                                <?php echo e(old('salary_range') ? (old('salary_range') == $data ? 'selected' : '') : ''); ?>>
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        $(".add-skill").click(function() {
            $(".add_skill").append(
                ` <div class="col-6 varient d-flex mb-2"><select class="form-select form-control" name="skill[]" aria-label="Default select example" required>
                        <option value="">Select Skill</option>
                        <?php $__currentLoopData = $skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($skill->id); ?>"><?php echo e($skill->title); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>  <span id="remove" class="remove btn btn-outline-danger"><i class="fa fa-trash"></i></span>
                        <?php $__errorArgs = ['skill'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/megajobn/public_html/resources/views/admin/job/components/add.blade.php ENDPATH**/ ?>