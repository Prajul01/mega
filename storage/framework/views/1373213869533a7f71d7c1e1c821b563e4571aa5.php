...
<head>
    ...
    <link rel="icon" href="<?php echo e($setting->favicon ? asset('storage/setting/favicon/' . $setting->favicon) : ''); ?>"
        type="image/png" />
    <!-- VENDOR CSS -->
    ...
    <link rel="stylesheet" href="<?php echo e(asset('backend/assets/vendor/toastr/toastr.css')); ?>" />
    ...
    <link rel="stylesheet" href="<?php echo e(asset('backend/assets/css/colors.css')); ?>">
...
<body class="theme-cyan font-montserrat light_version mini_sidebar">
                        ...
                        <ul class="nav navbar-nav">
                            <li>
                                <a title="" data-toggle="tooltip" data-placement="top" class="icon-menu"
                                    href="<?php echo e(url('/')); ?>" target="_blank" data-original-title="Visit Site"><i
        ...
        <div id="left-sidebar" class="sidebar  ">
            <div class="navbar-brand">
                <a href="<?php echo e(route('admin.dashboard')); ?>">
                    <img src="<?php echo e(asset('storage/setting/favicon/' . $setting->favicon)); ?>" alt=""
                        class="img-fluid logo">
                    <span><?php echo e($setting->site_title); ?></span>
                </a>
            ...
            <div class="sidebar-scroll">
                <div class="user-account">
                    <div class="user_div">
                        <img src="<?php echo e(asset('storage/setting/favicon/' . $setting->favicon)); ?>" class="user-photo"
                            alt="User Profile Picture">
                        <span>Welcome, <br> <?php echo e(auth()->user()->name); ?></span>
                    </div>
                </div>
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu">
                        ...
                        <li class="<?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('admin.dashboard')); ?>" data-toggle="tooltip" data-placement="right"
                                title="User Dashboard">
                                <i class="icon-speedometer"></i><span>Dashboard</span>
                            </a>
                        </li>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('site-list')): ?>
                            <li class="header"><b>Site Management</b></li>

                            <li class="<?php echo e(request()->routeIs('admin.setting.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.setting.index')); ?>" data-toggle="tooltip"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role-list')): ?>
                            ...
                            <li class="<?php echo e(request()->routeIs('admin.roles.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.roles.index')); ?>" data-toggle="tooltip" data-placement="right"
                                    title="Roles">
                        ...
                        <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'super-admin')): ?>
                            ...
                            <li class="<?php echo e(request()->routeIs('admin.admin-management.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.admin-management.index')); ?>" data-toggle="tooltip"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-list')): ?>
                            ...
                            <li class="<?php echo e(request()->routeIs('admin.adminUsers.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.adminUsers.index')); ?>" data-toggle="tooltip"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('employer-list')): ?>
                            ...
                            <li class="<?php echo e(request()->routeIs('admin.employers.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.employers.index')); ?>" data-toggle="tooltip"
                                    data-placement="right" title="Employers">
                                    <i class="fa fa-users"></i><span>Employers </span>
                                </a>
                            </li>

                            <li class="<?php echo e(request()->routeIs('admin.employer.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.employer.index')); ?>" data-toggle="tooltip"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-list')): ?>
                            ...
                            <li class="<?php echo e(request()->routeIs('admin.users.admins.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.users.admins.index')); ?>" data-toggle="tooltip"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('job-list')): ?>
                            ...
                            <li class="<?php echo e(request()->routeIs('admin.job-management.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.job.index')); ?>" data-toggle="tooltip" data-placement="right"
                                    title="Jobs">
                                    <i class="fa fa-suitcase"></i><span>Jobs</span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.jobRequest.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.jobRequest.index')); ?>" data-toggle="tooltip"
                            ...
                            <li class=""><a aria-current="page" class="has-arrow active"><i
                                ...
                                <ul
                                    class="collapse collapse collapse collapse collapse collapse collapse <?php echo e(request()->routeIs('admin.jobPosting.*') ? 'in' : ''); ?>">
                                    <li class=""><a
                                            href="<?php echo e(route('admin.jobPosting.index', 'megajobs')); ?>"><span>Megajobs</span></a>
                                    </li>
                                    <li class=""><a
                                            href="<?php echo e(route('admin.jobPosting.index', 'premium-jobs')); ?>"><span>Premium
                                                Jobs</span></a></li>
                                    <li class=""><a
                                            href="<?php echo e(route('admin.jobPosting.index', 'prime-jobs')); ?>"><span>Prime
                                                Jobs</span></a></li>
                                    <li class=""><a
                                            href="<?php echo e(route('admin.jobPosting.index', 'other-jobs')); ?>"><span>Other
                                                Jobs</span></a></li>
                                </ul>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('job-list')): ?>
                            ...
                            <li class="<?php echo e(request()->routeIs('admin.skill.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.skill.index')); ?>" data-toggle="tooltip" data-placement="right"
                                    title="Skills">
                                    <i class="fa fa-cogs"></i><span> Skills</span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.employee_type.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.employee_type.index')); ?>" data-toggle="tooltip"
                                    data-placement="right" title="Employee Type">
                                    <i class="fa fa-users"></i><span> Employee Type</span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.language.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.language.index')); ?>" data-toggle="tooltip"
                                    data-placement="right" title="Language">
                                    <i class="fa fa-language"></i><span> Language</span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.JobLevel.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.JobLevel.index')); ?>" data-toggle="tooltip"
                                    data-placement="right" title="Job Level">
                                    <i class="fa fa-shopping-basket"></i><span> Job Level</span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.experience.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.experience.index')); ?>" data-toggle="tooltip"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('company-list')): ?>
                            ...
                            <li class="<?php echo e(request()->routeIs('admin.industry.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.industry.index')); ?>" data-toggle="tooltip"
                                    data-placement="right" title="Industries">
                                    <i class="icon-layers"></i><span>Industries</span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.company_category.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.company_category.index')); ?>" data-toggle="tooltip"
                                    data-placement="right" title="Departments">
                                    <i class="icon-layers"></i><span>Departments</span>
                                </a>
                            </li>

                            <li class="<?php echo e(request()->routeIs('admin.company_ownership.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.company_ownership.index')); ?>" data-toggle="tooltip"
                                    data-placement="right" title="Company Ownership">
                                    <i class="icon-badge"></i><span>Company Ownership</span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.company_size.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.company_size.index')); ?>" data-toggle="tooltip"
                                    data-placement="right" title="Company Size">
                                    <i class="fa fa-users"></i><span>Company Size</span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.vehicle.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.vehicle.index')); ?>" data-toggle="tooltip"
                                    data-placement="right" title="Vehicle">
                                    <i class="fa fa-motorcycle"></i><span>Vehicle</span>
                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('education-list')): ?>
                            <li class="header"><b>Education Management</b></li>
                            <li class="<?php echo e(request()->routeIs('admin.education.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.education.index')); ?>" data-toggle="tooltip"
                                    data-placement="right" title="Education">
                                    <i class="fa fa-graduation-cap"></i><span> Education</span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.studyfield.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.studyfield.index')); ?>" data-toggle="tooltip"
                                    data-placement="right" title="Study Fields">
                                    <i class="fa fa-graduation-cap"></i><span>Study Fields</span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.studysubject.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.studysubject.index')); ?>" data-toggle="tooltip"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('location-list')): ?>
                            ...
                            <li class="<?php echo e(request()->routeIs('admin.district.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.district.index')); ?>" data-toggle="tooltip"
                                    data-placement="right" title="Districts">
                                    <i class="fa fa-area-chart"></i><span>Districts</span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.city.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.city.index')); ?>" data-toggle="tooltip" data-placement="right"
                                    title="Cities">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('tender-list')): ?>
                            ...
                            <li class="<?php echo e(request()->routeIs('admin.tender_type.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.tender_type.index')); ?>" data-toggle="tooltip"
                                    data-placement="right" title="Tender Type">
                                    <i class="fa fa-file"></i><span>Tender Type</span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.tender_category.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.tender_category.index')); ?>" data-toggle="tooltip"
                                    data-placement="right" title="Tender Category">
                                    <i class="fa fa-suitcase"></i><span>Tender Category</span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.tender.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.tender.index')); ?>" data-toggle="tooltip" data-placement="right"
                                    title="Tender">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('content-list')): ?>
                            ...
                            <li class="<?php echo e(request()->routeIs('admin.tag.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.tag.index')); ?>" data-toggle="tooltip" data-placement="right"
                                    title="Tag">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('report-list')): ?>
                            ...
                            <li class="<?php echo e(request()->routeIs('admin.reports.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.reports.index')); ?>" data-toggle="tooltip"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('career-list')): ?>
                            ...
                            <li class="<?php echo e(request()->routeIs('admin.career.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.career.index')); ?>" data-toggle="tooltip" data-placement="right"
                                    title="Career">
                        ...
                        <li class="<?php echo e(request()->routeIs('admin.dayPackages.*') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('admin.dayPackages.index')); ?>" data-toggle="tooltip"
                                data-placement="right" title="DAy8 Packages">
                                <i class="fa fa-clock-o"></i><span>Day Packages</span>
                            </a>
                        </li>
                        <li class="<?php echo e(request()->routeIs('admin.dayPackages.*') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('admin.steps.index')); ?>" data-toggle="tooltip" data-placement="right"
                                title="Step Procedures">
                                <i class="fa fa-tasks"></i><span>Step Procedures</span>
                            </a>
                        </li>
                        <li class="<?php echo e(request()->routeIs('admin.adBanner.*') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('admin.adBanner.index')); ?>" data-toggle="tooltip"
                                data-placement="right" title="Banner">
                                <i class="fa fa-image"></i><span>Banner</span>
                            </a>
                        </li>
                        <li class="<?php echo e(request()->routeIs('admin.pricing.*') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('admin.pricing.mainIndex')); ?>" data-toggle="tooltip"
                                data-placement="right" title="Pricing Management">
                                <i class="fa fa-usd"></i><span>Pricing Management</span>
                            </a>
                        </li>
                        <li class="<?php echo e(request()->routeIs('admin.staffs.*') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('admin.staffs.index')); ?>" data-toggle="tooltip"
                                data-placement="right" title="Support Staff Info">
                                <i class="fa fa-users"></i><span>Support Staff Info</span>
                            </a>
                        </li>

                        <li class="<?php echo e(request()->routeIs('admin.adContent.*') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('admin.adContent.index')); ?>" data-toggle="tooltip"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('content-list')): ?>
                            <li class="header"><b>Content Management</b></li>
                             <li class="<?php echo e(request()->routeIs('admin.advertisement.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.advertisement.index')); ?>" data-toggle="tooltip"
                                    data-placement="right" title="Advertisement">
                                    <i class="fa fa-image"></i><span>Advertisement Management</span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.sliders.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.sliders.index')); ?>" data-toggle="tooltip"
                                    data-placement="right" title="Slider">
                                    <i class="fa fa-image"></i><span>Slider</span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.about.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.about.index')); ?>" data-toggle="tooltip" data-placement="right"
                                    title="About">
                                    <i class="fa fa-info"></i><span>About </span>
                                </a>
                            </li>

                            <li class="<?php echo e(request()->routeIs('admin.blog.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.blog.index')); ?>" data-toggle="tooltip" data-placement="right"
                                    title="Blog">
                                    <i class="fa fa-rss"></i><span>Blog </span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.faq.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.faq.index')); ?>" data-toggle="tooltip" data-placement="right"
                                    title="FAQ">
                                    <i class="fa fa-question-circle"></i><span>FAQ </span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.concern.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.concern.index')); ?>" data-toggle="tooltip"
                            ...
                            <li class="<?php echo e(request()->routeIs('admin.news.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.news.index')); ?>" data-toggle="tooltip" data-placement="right"
                                    title="News And Announcement">
                                    <i class="fa fa-newspaper-o"></i><span>News And Announcement</span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.terms.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.terms.index')); ?>" data-toggle="tooltip" data-placement="right"
                                    title="Terms And Condition">
                                    <i class="fa fa-gavel"></i><span>Terms And Condition </span>
                                </a>
                            </li>
                            <li class="<?php echo e(request()->routeIs('admin.privacy.*') ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('admin.privacy.index')); ?>" data-toggle="tooltip"
    ...
    <script>
        ...
        function postStatus(slug, value, message = null) {
            ...
            $.ajax({
                method: 'POST',
                url: "<?php echo e(route('admin.jobRequest.changeStatus', '')); ?>/" + slug,
                data: {
...
<?php /**PATH /home/megajobn/public_html/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>