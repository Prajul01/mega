    ...
    <div class="dd" id="nestable">
        <ol class="dd-list has-header">
            <?php $__currentLoopData = $tender_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tender_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="dd-item dd3-item list-item" data-id="<?php echo e($tender_type->id); ?>">
                    <div class="dd-handle dd3-handle"></div>
                    <div class="custom-handle-flex">
                        <div class="icon-image-name">
                            <div>
                                <h6 class=" mb-0">
                                    <?php echo e($tender_type->title); ?> | <small
                                        class="<?php echo e($tender_type->status == 'active' ? 'badge badge-primary' : 'badge badge-danger'); ?>"><?php echo e($tender_type->status == 'active' ? 'Displayed' : 'Not Display'); ?></small>
                                </h6>
                            </div>
                        </div>
                        <div style="display: flex">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('tender-edit')): ?>
                                <a href="<?php echo e(route('admin.tender_type.edit', base64_encode($tender_type->id))); ?>"
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('tender-delete')): ?>
                                &nbsp;
                                <button type="button" onclick="COnfirmDelete('<?php echo e($tender_type->id); ?>')"
                                    data-id="<?php echo e($tender_type->id); ?>" class="btn btn-sm btn-outline-danger">
    ...
    <script>
        $(document).ready(function() {
            var updateOutput = function(e) {
                ...
                $.ajax({
                    method: "POST",
                    url: "<?php echo e(route('admin.tender_type.order')); ?>",
                    data: {
        ...
        function COnfirmDelete(elem) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        method: "POST",
                        url: '<?php echo e(route('admin.tender_type.destroy')); ?>',
                        data: {
                        ...
                        success: function(res) {
                            swal({
                                title: "Deleted",
                                text: "Tender Type has been deleted!",
                                type: "success",
                    ...
                    swal("Cancelled", "Your Tender Type is safe :)", "error");
                }
            });
        }
    </script>
<?php $__env->stopPush(); ?>
<?php /**PATH /home/megajobn/public_html/resources/views/admin/tender_type/components/list.blade.php ENDPATH**/ ?>