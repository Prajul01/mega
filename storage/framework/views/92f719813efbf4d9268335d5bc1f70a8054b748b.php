    ...
    <div class="dd" id="nestable">
        <ol class="dd-list has-header">
            <?php $__currentLoopData = $company_sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company_size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="dd-item dd3-item list-item" data-id="<?php echo e($company_size->id); ?>">
                    <div class="dd-handle dd3-handle"></div>
                    <div class="custom-handle-flex">
                        <div class="icon-image-name">
                            <div>
                                <h6 class=" mb-0">
                                    <?php echo e($company_size->title); ?> | <small
                                        class="<?php echo e($company_size->status == 'active' ? 'badge badge-primary' : 'badge badge-danger'); ?>"><?php echo e($company_size->status == 'active' ? 'Displayed' : 'Not Display'); ?></small>
                                </h6>
                            </div>
                        </div>
                        <div style="display: flex">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('company-edit')): ?>
                                <a href="<?php echo e(route('admin.company_size.edit', base64_encode($company_size->id))); ?>"
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('company-delete')): ?>
                                &nbsp;
                                <button type="button" onclick="COnfirmDelete('<?php echo e($company_size->id); ?>')"
                                    data-id="<?php echo e($company_size->id); ?>" class="btn btn-sm btn-outline-danger">
    ...
    <script>
        $(document).ready(function() {
            var updateOutput = function(e) {
                ...
                $.ajax({
                    method: "POST",
                    url: "<?php echo e(route('admin.company_size.order')); ?>",
                    data: {
        ...
        function COnfirmDelete(elem) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        method: "POST",
                        url: '<?php echo e(route('admin.company_size.destroy')); ?>',
                        data: {
                        ...
                        success: function(res) {
                            swal({
                                title: "Deleted",
                                text: "company size has been deleted!",
                                type: "success",
                    ...
                    swal("Cancelled", "Your company size is safe :)", "error");
                }
            });
        }
    </script>
<?php $__env->stopPush(); ?>
<?php /**PATH /home/megajobn/public_html/resources/views/admin/company_size/components/list.blade.php ENDPATH**/ ?>