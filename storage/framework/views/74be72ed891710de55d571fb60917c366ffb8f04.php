...
<?php $__env->stopPush(); ?>
<form method="POST" action="<?php echo e(route('admin.tender_type.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="body">
        <div class="row">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="card-footer">
        <a href="<?php echo e(route('admin.tender_type.index')); ?>" class="btn btn-danger">Cancel</a>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/megajobn/public_html/resources/views/admin/tender_type/components/add.blade.php ENDPATH**/ ?>