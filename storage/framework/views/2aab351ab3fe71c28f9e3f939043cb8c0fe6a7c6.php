...
<?php $__env->stopPush(); ?>
<form method="POST" action="<?php echo e(route('admin.career.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="body">
        <div class="row">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/megajobn/public_html/resources/views/admin/career/components/add.blade.php ENDPATH**/ ?>