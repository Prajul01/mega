       ...
       <div class="card side-bar new-shadow-sidebar mb-3">
           <div class="card-body p-3">
               ...
               <div class="candidate-detail-sidebar">
                   <?php if($user_profile->current_city != null): ?>
                       <div class="icon-detail-candidate">
                           ...
                           <div class="detail-section">
                               ...
                               <div class="detail-info">
                                   <?php echo e(\App\Models\City::find($user_profile->current_city)->name); ?>,
                                   <?php echo e(\App\Models\District::find($user_profile->current_district)->name); ?>

                               </div>
                           </div>
                       </div>
                   <?php endif; ?>
                   <?php if($user_profile->date_of_birth != null): ?>
                       <div class="icon-detail-candidate">
                           <div class="icon-section">
                           ...
                           <div class="detail-section">
                               ...
                               <div class="detail-info">
                                   <?php echo e($user_profile->date_of_birth); ?>

                               </div>
                           </div>
                       </div>
                   <?php endif; ?>
                   <?php if($user_profile->expected_salary != null): ?>
                       <div class="icon-detail-candidate">
                           <div class="icon-section">
                           ...
                           <div class="detail-section">
                               ...
                               <div class="detail-info">
                                   NRs. <?php echo e($user_profile->expected_salary); ?>
                   ...
                   <?php if(isset($preferedJobs)): ?>
                       <div class="icon-detail-candidate">
                           ...
                           <div class="detail-section">
                               ...
                               <div class="detail-info">
                                   <?php echo e(isset($preferedJobs) ? $preferedJobsList : ''); ?>
                   ...
                   <?php endif; ?>
                   <?php if($totalCompleteProfile > 45): ?>
                       <div class="icon-detail-candidate">
                           <div class="icon-section">
                               <i class="fa-solid fa-file-pdf"></i>
                           </div>
                           <div class="detail-section">
                               <a href="<?php echo e(route('user.download', auth()->user()->username)); ?>">
                       ...
                       <div class="icon-detail-candidate">
                           ...
                           <div class="detail-section">
                               <a href="<?php echo e(route('user.view_profile', auth()->user()->username)); ?>">
...
<?php /**PATH /home/megajobn/public_html/resources/views/user/jobseeker/layouts/sidebar.blade.php ENDPATH**/ ?>