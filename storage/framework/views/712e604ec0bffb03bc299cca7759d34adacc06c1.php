...
<?php $__env->stopPush(); ?>
<form method="POST" action="<?php echo e(route('admin.city.update', base64_encode($city->id))); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="body">
        <div class="row">
            <div class="col-md-9 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="city_name" placeholder="City Name"
                        value="<?php echo e(old('city_name',$city->name)); ?>" aria-label="Title" aria-describedby="basic-addon1" required>
                </div>
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><input type="checkbox" name="status" value="active"
                                <?php if($city->status == 'active'): ?> checked <?php endif; ?>></span>
                    </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="district_name">
                        ...
                        <option value="<?php echo e($district->id); ?>" <?php echo e($city->district_id==$district->id?"selected":''); ?>><?php echo e($district->name); ?></option>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/megajobn/public_html/resources/views/admin/city/components/edit.blade.php ENDPATH**/ ?>