...
<?php $__env->stopPush(); ?>
<form method="POST" action="<?php echo e(route('admin.blog.update', base64_encode($blog->id))); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="body">
        <div class="row">
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="title" placeholder="Title"
                        value="<?php echo e(old('title', $blog->title)); ?>" aria-label="Title" aria-describedby="basic-addon1"
                        required>
                </div>
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><input type="checkbox" name="status" value="active"
                                <?php if($blog->status == 'active'): ?> checked <?php endif; ?>></span>
                    </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="author" placeholder="Author" aria-label="Auhor"
                        aria-describedby="basic-addon1" value="<?php echo e(old('author', $blog->author)); ?>">
                </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="company_name" placeholder="Company Name"
                        ...
                        value="<?php echo e(old('company_name', $blog->company_name)); ?>">
                </div>
                ...
                <div class="input-group">
                    ...
                    <select class="multiple-cat form-control" name="tag[]" multiple="multiple" required>
                        ...
                        <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($tag->title); ?>" <?php echo e(in_array($tag->title,old('tag', @$savedTags)) ? 'selected' : ''); ?>>
            ...
            <div class="col-md-12 mb-3">
                <div class="input-group">
                    ...
                    <input type="file" name="image"
                        data-default-file="<?php echo e(asset('storage/blog/' . $blog->image)); ?>" class="dropify">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-12 mb-3">
                <div class="input-group">
                    ...
                    <textarea name="description" id="ckeditor" class="form-control" required><?php echo old('description', $blog->description); ?></textarea>
                </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/megajobn/public_html/resources/views/admin/blog/components/edit.blade.php ENDPATH**/ ?>