<?php $__env->startSection('title', 'Advertisement Plans'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="main">
        <section class="advertise" style="background-color: #fff;">
            <div class="container online-ads">
                <div class="row">
                    <div class="col-lg-8 m-auto hero-banner mb-4">
                        <div class="d-flex justify-content-center">
                            <img src="<?php echo e(asset('frontend/assets/images/icon-1.png')); ?>" alt="" />
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img class="w-100" src="<?php echo e(asset('frontend/assets/images/mega-display.png')); ?>" class="img-fluid"
                            alt="">
                    </div>
                </div>
            </div>
                            ...
                            <?php $__currentLoopData = $supportStaffs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-lg-4 d-flex touch-text py-4">
                                    <img class="rounded-img"
                                        src="<?php echo e(asset('/storage/supportStaff/' . $staff->profile_pic)); ?>" alt="">
                                    <div class="justify-content-center align-self-center">
                                        <h6 class=""><?php echo e($staff->name); ?></h6>
                                        <h6><a href="tel:<?php echo e($staff->phone_no); ?>" class="text-dark">+977 <?php echo e($staff->phone_no); ?></a></h6>
                                        <h6><a href="mailto:<?php echo e($staff->email); ?>" class="text-dark"><?php echo e($staff->email); ?></a></h6>
                                    </div>
                                </div>
        ...
        <section>
            <div>
                <iframe
                    src="<?php echo e($setting->googlemap_url); ?>"
...
<?php echo $__env->make('user.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/megajobn/public_html/resources/views/user/banner-job.blade.php ENDPATH**/ ?>