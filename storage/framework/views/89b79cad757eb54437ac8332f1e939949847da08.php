            ...
            <div class="col-md-9 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="Enter Name" aria-label="Name"
                        aria-describedby="basic-addon1" value="<?php echo e(old('name')); ?>" required>
                </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="email" placeholder="Enter email"
                        aria-label="email" aria-describedby="basic-addon1" value="<?php echo e(old('email')); ?>" required>
                </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="phone_no" placeholder="Enter phone_no"
                        aria-label="phone_no" aria-describedby="basic-addon1" value="<?php echo e(old('phone_no')); ?>" required>
                </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/megajobn/public_html/resources/views/admin/supportStaff/components/add.blade.php ENDPATH**/ ?>