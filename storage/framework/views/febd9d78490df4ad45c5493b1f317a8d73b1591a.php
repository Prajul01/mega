<form method="POST" action="<?php echo e(route('admin.education.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="body">
        <div class="row">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-12 mb-3">
                <div class="input-group">
                    ...
                    <input type="file" name="image" class="dropify" value="<?php echo e(old('iage')); ?>" required>
                </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/megajobn/public_html/resources/views/admin/education/components/add.blade.php ENDPATH**/ ?>