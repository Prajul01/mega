<form method="POST" action="<?php echo e(route('admin.district.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="body">
        <div class="row">
            <div class="col-md-9 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="district_name" placeholder="District Name" aria-label="Title"
                        aria-describedby="basic-addon1" value="<?php echo e(old('district_name')); ?>" required>
                </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="province_name">
                        ...
                        <option value="<?php echo e($province->id); ?>" <?php echo e(old('province_name')==$province->id?"selected":''); ?>><?php echo e($province->name); ?></option>
...
</form><?php /**PATH /home/megajobn/public_html/resources/views/admin/district/components/add.blade.php ENDPATH**/ ?>