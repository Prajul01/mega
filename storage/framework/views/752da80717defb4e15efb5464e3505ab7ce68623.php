<?php $__env->startSection('title', 'Setting | Job Seeker'); ?>
                                ...
                                <div class="card-body p-3">
                                    <div class="tab-content" id="v-pills-tabContent">
                                                        ...
                                                        <div class="btn-container">
                                                            <label class="switch btn-color-mode-switch">
                                                                <input value="Profile Searchable"
                                                                    ...
                                                                    class="change_status"
                                                                    <?php echo e(auth()->user()->job_sekeer_profile_searchable == 1 ? 'checked' : ''); ?>>
                                                        ...
                                                        <div class="btn-container">
                                                            <label class="switch btn-color-mode-switch">
                                                                <input value="Actively Seeking Job"
                                                                    ...
                                                                    class="change_status"
                                                                    <?php echo e(auth()->user()->job_sekeer_seeking_job == 1 ? 'checked' : ''); ?>>
                                                                <label class="btn-color-mode-switch-inner" data-off="NO"
                                                        ...
                                                        <div class="btn-container">
                                                            <label class="switch btn-color-mode-switch">
                                                                <input value="Profile confidential"
                                                                    ...
                                                                    class="change_status"
                                                                    <?php echo e(auth()->user()->job_sekeer_profile_confidential == 1 ? 'checked' : ''); ?>>
                                                                <label class="btn-color-mode-switch-inner" data-off="NO"
                                                                    data-on="YES"
                                                        ...
                                                        <div class="btn-container">
                                                            <label class="switch btn-color-mode-switch">
                                                                <input value="Email Alert" id="job_sekeer_job_alert"
                                                                    ...
                                                                    type="checkbox"
                                                                    <?php echo e(auth()->user()->job_sekeer_job_alert == 1 ? 'checked' : ''); ?>>
                                                                <label class="btn-color-mode-switch-inner" data-off="NO"
                                        ...
                                        <div class="tab-pane fade" id="v-pills-messages" role="tabpanel"
                                            ...
                                            <form action="<?php echo e(route('user.change_password', auth()->user()->username)); ?>"
                                        ...
                                        <div class="tab-pane fade" id="v-pills-deactivate" role="tabpanel"
                                            ...
                                            <div class="tab-main-content social-card">
                                                <form
                                                    action="<?php echo e(route('user.account_deactivated', auth()->user()->username)); ?>"
                                                    ...
                                                    <label for="permanent" class="flex-label">
                                                        <div class="message">
                                                            <?php if(auth()->user()->is_deactivated == 0): ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.change_status').change(function() {
                ...
                $.ajax({
                    url: '<?php echo e(route('user.change_setting', auth()->user()->username)); ?>', // Correct URL format
                    method: 'Get',
                    data: {
                        name: name,
                    },
...
<?php echo $__env->make('user.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/megajobn/public_html/resources/views/user/jobseeker/seeker-setting.blade.php ENDPATH**/ ?>