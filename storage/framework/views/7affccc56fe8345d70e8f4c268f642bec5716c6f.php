...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="card-footer">
        <a href="<?php echo e(route('admin.language.index')); ?>" class="btn btn-danger">Cancel</a>
        <button style="float: right" type="submit" class="btn btn-success">Save</button>
    </div>
</form>
<?php /**PATH /home/megajobn/public_html/resources/views/admin/language/components/add.blade.php ENDPATH**/ ?>