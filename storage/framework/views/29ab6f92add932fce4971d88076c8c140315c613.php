<form method="POST" action="<?php echo e(route('admin.studyfield.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="body">
        <div class="row">
            ...
            <div class="col-md-9 mb-3">
                <div class="input-group">
                    ...
                    <select class="form-select form-control" name="education" aria-label="Default select example">
                        ...
                        <option value="<?php echo e($education->id); ?>"><?php echo e($education->title); ?></option>
...
<?php /**PATH /home/megajobn/public_html/resources/views/admin/studyfield/components/add.blade.php ENDPATH**/ ?>