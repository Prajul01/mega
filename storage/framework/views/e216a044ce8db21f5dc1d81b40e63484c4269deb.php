...
<?php $__env->stopPush(); ?>
<form method="POST" action="<?php echo e(route('admin.industry.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="body">
        <div class="row">
            <div class="col-md-9 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="Industry Name"
                        aria-label="Title" aria-describedby="basic-addon1" value="<?php echo e(old('name')); ?>" required>
                </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/megajobn/public_html/resources/views/admin/industry/components/add.blade.php ENDPATH**/ ?>