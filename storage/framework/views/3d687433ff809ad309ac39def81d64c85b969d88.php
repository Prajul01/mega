...
<?php $__env->stopPush(); ?>
<form method="POST" action="<?php echo e(route('admin.tender.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="body">
        <div class="row">
            ...
            <div class="col-md-8 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="sub_title" placeholder="Sub Title" aria-label="Title"
                        aria-describedby="basic-addon1" value="<?php echo e(old('sub_title')); ?>">
                </div>
            ...
            <div class="col-md-4 mb-3">
                <div class="input-group">
                    ...
                    <input type="date" class="form-control" id="date" name="deadline_date" placeholder="Date" aria-label="Date"
                        aria-describedby="basic-addon1" value="<?php echo e(old('deadline_date')); ?>">
                </div>
                ...
                <div class="input-group">
                    ...
                    <select class="multiple-cat form-control" name="tag[]" multiple="multiple">
                        <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <option value="<?php echo e($tag->title); ?>"  <?php echo e(old('tag') == $tag->title ? 'selected' : ''); ?>>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="tender_category">
                        ...
                        <?php $__currentLoopData = $tender_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($category->id); ?>" <?php echo e(old('tender_category')==$category->id?'selected':''); ?>><?php echo e($category->title); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                </div>
                <?php $__errorArgs = ['tender_category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <div class="col-md-6 mb-3">
                <div class="input-group">
                    ...
                    <select class="form-select form-control" aria-label="Default select example" name="tender_type">
                        ...
                        <?php $__currentLoopData = $tender_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($type->id); ?>" <?php echo e(old('tender_type')==$type->id?'selected':''); ?>><?php echo e($type->title); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                </div>
                <?php $__errorArgs = ['tender_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-12 mb-3">
                <div class="input-group">
                    ...
                    <textarea name="description"  class="form-control"  id="ckeditor" rows="5"><?php echo e(old('description')); ?></textarea>
                </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-12 mb-3">
                <div class="input-group">
                    ...
                    <input type="file" name="logo" class="dropify" data-default-file="<?php echo e(old('logo')); ?>">
                </div>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="card-footer">
        <a href="<?php echo e(route('admin.tender.index')); ?>" class="btn btn-danger">Cancel</a>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/megajobn/public_html/resources/views/admin/tender/components/add.blade.php ENDPATH**/ ?>