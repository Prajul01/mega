<form method="POST" action="<?php echo e(route('admin.company_ownership.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="body">
        <div class="row">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="card-footer">
        <a href="<?php echo e(route('admin.company_ownership.index')); ?>" class="btn btn-danger">Cancel</a>
        <button style="float: right" type="submit" class="btn btn-success">Save</button>
    </div>
</form>
<?php /**PATH /home/megajobn/public_html/resources/views/admin/company_ownership/components/add.blade.php ENDPATH**/ ?>