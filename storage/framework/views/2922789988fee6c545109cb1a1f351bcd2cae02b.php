...
<?php $__env->startSection('title', 'Welcome to Employer Portal'); ?>
                            ...
                            <div class="row g-0">
                                <div class="col-lg-6 tab-none text-center">
                                    <div class="card-body p-4">
                                        ...
                                        <div class="mt-5">
                                            <img src="<?php echo e(asset('frontend/assets/images/files/login-megajob.png')); ?>"
                                                alt="" class="img-fluid">
                                        </div>
                                    </div>
                                </div><!--end col-->
                                <div class="col-lg-6 col-md-10 offset-md-1 offset-lg-0">
                                    <div class="auth-content card-body p-5 py-4 h-100 text-white">
                                        <div class="w-100">
                                            ...
                                            ?>
                                            <form action="<?php echo e($url); ?>" method="POST" class="auth-form">
                                                <?php echo csrf_field(); ?>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-4">
                                                    <div class="form-check"><input class="form-check-input" name="remember"
                                                        ...
                                                        <a href="<?php echo e(route('employers.forget.password.get')); ?>"
                                            ...
                                            <div class="mt-4 text-center">
                                                <p class="mb-0">Don't have an account ? <a
                                                        href="<?php echo e(route('employers.signup')); ?>"
...
<?php echo $__env->make('user.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/megajobn/public_html/resources/views/employer/auth/login.blade.php ENDPATH**/ ?>