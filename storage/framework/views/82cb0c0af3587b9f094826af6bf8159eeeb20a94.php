		...
		<table width="600" height="108" border="0" cellpadding="0" cellspacing="0" align="center" class="border-lr deviceWidth" bgcolor="#ecf0fb">
			<tr>
				<td style="padding-left: 40px;padding-right: 40px; padding-top: 40px; color: #095583;">
					<p>Full Name :&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($contact->full_name); ?></p>
					<p>Email :&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($contact->email); ?></p>
					<p>Phone :&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($contact->phone_number); ?></p>
                    <p>Subject :&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($contact->subject); ?></p>
					<hr>
					<h3 style="text-align: center;">Additional Message</h3>
					<p id="banner-txt" style="padding-bottom: 10px; color: #095583;"><?php echo e($contact->message); ?></p>
				</td>
			</tr>
		</table>
		<!-- End of Banner Text -->
			...
			<tr>
				<td style="text-align: center;">
					<p id="footer-txt" style="padding-top: 20px; padding-bottom: 20px; color:#eeeeed ">
						<b>© Copyright  <?php echo e(date("Y")); ?> - Mega Job - All Rights Reserved</b>
					</p>
				</td>
			</tr>
		</table>
...
</html><?php /**PATH /home/megajobn/public_html/resources/views/emails/ContactMail.blade.php ENDPATH**/ ?>