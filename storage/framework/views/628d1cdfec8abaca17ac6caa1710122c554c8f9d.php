<?php $__env->startSection('title'); ?><?php echo e('Tender'); ?> <?php $__env->stopSection(); ?>
                            ...
                            <div class="tender-categories">
                                ...
                                <div class="categories-list">
                                    ...
                                    <div class="tender-list">
                                        <?php if(count($tender_categories)!==0): ?>
                                            <?php $__currentLoopData = $tender_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e(route('tender',['category'=>$category->slug])); ?>">
                                            <?php echo e($category->title); ?> (<?php echo e($category->tenders->count()); ?>)
                                            </a>
                            ...
                            <div class="tender-categories">
                                ...
                                <div class="categories-list">
                                    <div class="tender-list">
                                        ...
                                        <?php $__currentLoopData = $tender_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(route('tender',['type'=>$type->slug])); ?>">
                                            <?php echo e($type->title); ?> (<?php echo e($type->tenders->count()); ?>)
                                        </a>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-2">
                                            <div class="company-image">
                                                <a href="<?php echo e(route('tender_details',['tender'=>$tender->slug])); ?>"><img
                                                        src="<?php echo e(asset('storage/tender/'.$tender->logo)); ?>" alt=""
                                        ...
                                        <div class="col-lg-10">
                                            <div class="job-desc-company">
                                                <div class="mt-3 mt-lg-0 tender-heading">
                                                    <h5 class="fs-20 mb-0"><a href="<?php echo e(route('tender_details',['tender'=>$tender->slug])); ?>">
                                                            <?php echo e($tender->title); ?></a>
                                                    </h5>
                                                    <p class="fs-16 mb-3">
                                                        <a href="<?php echo e(route('tender_details',['tender'=>$tender->slug])); ?>" class="text-dark">
                                                           <?php echo e($tender->sub_title); ?>
                                                ...
                                                <div class="tender-main-info">
                                                    <div class="tender-info">
                                                        ...
                                                        <div class="tender-desc">
                                                            <?php echo e($tender->tender_categories->title); ?>
                                                    ...
                                                    <div class="tender-info">
                                                        ...
                                                        <div class="tender-desc">
                                                           <?php echo e($tender->created_at->format("F j, Y")); ?>
                                                    ...
                                                    <div class="tender-info">
                                                        ...
                                                        <div class="tender-desc">
                                                          <?php echo e(date("F j, Y",strtotime($tender->deadline))); ?>
                            ...
                            <div class="sidebox-wrap">
                                ...
                                <div class="sidebox-content">
                                    <ul class="recent-tender">
                                        <?php if(count($recent_tenders)>0): ?>
                                            <?php $__currentLoopData = $recent_tenders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recent_tender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li>
                                                <p>
                                                    <a href="<?php echo e(route('tender_details',['tender'=>$recent_tender->slug])); ?>" class="flex-link">
                                                        <img src="<?php echo e(asset('storage/tender/'.$recent_tender->logo)); ?>"
                                                            class="img-fluid" alt="">
                                                          <?php echo e($recent_tender->title); ?>
                                        ...
                                        <li>
                                            <p class="px-2 d-block text-end">
                                                <a href="<?php echo e(route('tender',['tender'=>'all'])); ?>">
                                                    View All Tenders
                                                </a>
                                            </p>
                                        </li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/megajobn/public_html/resources/views/user/tender.blade.php ENDPATH**/ ?>