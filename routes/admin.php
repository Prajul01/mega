...
//                        Route::post('/order_no', 'AdvertisementController@set_order')->name('order');
        ...
        Route::name('trainingenroll.')
            ->prefix('trainingenroll-management')
            ->group(function () {
                Route::get('/', 'TrainningEnrollController@index')->name('index');
//                Route::get('/edit/{id}', 'TrainningEnrollController@edit')->name('edit');
//                Route::post('/store', 'TrainningEnrollController@store')->name('store');
//                Route::post('/update/{id}', 'TrainningEnrollController@update')->name('update');
//                Route::post('/delete', 'TrainningEnrollController@destroy')->name('destroy');
            });
    });
});
